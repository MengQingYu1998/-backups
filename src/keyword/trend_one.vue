<template>
  <div id="trend_one" class="content">
    <div class="trend_one_title">
      「{{ this.$route.query.now_app_name }}」搜索结果数排名走势
    </div>
    <div class="line"></div>
    <div class="options">
  ...
  methods: {
    ...
    get_data() {
      ...
      this.$axios
        ...
        .then(response => {
          ...
          // console.log(iosType)
          let word = this.$route.query.now_app_name;
          let data = {
    ...
    drawLine: function() {
      ...
      this.myChart.setOption(
        {
          title: {
            text: "【" + that.$route.query.now_app_name + "】搜索结果数走势",
            left: "center",
            textStyle: {
              color: "#222222",
              fontSize: 16,
