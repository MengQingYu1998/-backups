...
export function time_inactive(element) {
  ...
  // 这些是多个日期选择器
  document
    .querySelector(element + "  .el-input__icon")
    .setAttribute("class", "el-input__icon el-icon-caret-bottom");
...
export function time_active(element) {
  ...
  if (document.querySelector(element + "  .el-input__inner")) {
    ...
    // console.log(document.querySelector(element + "  .el-input__icon"));
  }
  // 这些是单个日期选择器
  // 这些是多个日期选择器
  if (
  ...
  document
    ...
    .setAttribute(
      "class",
      "el-input__icon el-icon-caret-bottom el-input__icon_ffffff"
    );
  document.styleSheets[0].addRule(
    element + " .el-date-editor::after",
